        ...
        <div className="flex justify-between items-center">
          ...
          <button
            className={`lg:hidden transition-colors duration-300 ${
              isScrolled ? 'text-gray-700 [text-shadow:_1px_1px_0_#000,_-1px_-1px_0_#000,_1px_-1px_0_#000,_-1px_1px_0_#000]' : 'text-white drop-shadow-[0_2px_4px_rgba(0,0,0,0.8)]'
            }`}
        ...
        {isMenuOpen && (
          <div className="lg:hidden fixed inset-0 z-50">
            ...
            <nav className="absolute top-0 left-0 right-0 bottom-0 bg-white">
              ...
              <button 
                onClick={() => handleNavClick('accueil')}
                className={`text-center font-bold text-xl transition-colors duration-300 py-3 uppercase tracking-wide ${
                  currentPage === 'accueil' 
                    ? 'text-blue-800' 
