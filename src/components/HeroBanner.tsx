...
import { Package, Truck, Car, ArrowRight } from 'lucide-react';
    ...
    <section className="relative text-white py-24 overflow-hidden min-h-[90vh] flex flex-col justify-center">
      ...
      <div className="relative z-20 container mx-auto px-4 h-full flex flex-col justify-center items-center text-center text-white pt-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl w-full">
          <button onClick={() => handleServiceClick('envoi-colis')} className="group bg-white/10 backdrop-blur-md border border-white/20 text-white p-8 rounded-xl shadow-2xl hover:bg-white/20 transform hover:-translate-y-2 transition-all duration-300">
            <div className="flex flex-col items-center space-y-4">
              <div className="p-4 rounded-full bg-blue-600 group-hover:bg-blue-500 transition-colors">
              ...
              <div className="flex items-center space-x-2 text-white border-2 border-blue-400 px-4 py-2 rounded-lg group-hover:bg-blue-500 group-hover:border-blue-500 transition-all">
          ...
          <button onClick={() => handleServiceClick('demenagement')} className="group bg-white/10 backdrop-blur-md border border-white/20 text-white p-8 rounded-xl shadow-2xl hover:bg-white/20 transform hover:-translate-y-2 transition-all duration-300">
            <div className="flex flex-col items-center space-y-4">
              <div className="p-4 rounded-full bg-red-600 group-hover:bg-red-500 transition-colors">
                <Truck size={32} className="text-white" />
              </div>
              <h3 className="text-xl font-bold">DEMENAGEMENT INTERNATIONAL</h3>
              <p className="text-blue-100 text-sm text-center">
          ...
          <button onClick={() => handleServiceClick('achat-livraison')} className="group bg-white/10 backdrop-blur-md border border-white/20 text-white p-8 rounded-xl shadow-2xl hover:bg-white/20 transform hover:-translate-y-2 transition-all duration-300">
            <div className="flex flex-col items-center space-y-4">
              <div className="p-4 rounded-full bg-purple-600 group-hover:bg-purple-500 transition-colors">
                <Car size={32} className="text-white" />
              </div>
              <h3 className="text-xl font-bold">ACHAT & TRANSPORT DE VÉHICULES</h3>
              <p className="text-blue-100 text-sm text-center">
